...
{ // Render the portrait of the current picture
	...
	snprintf((char*)filename, lengthof(filename), FACESDIR "/bigfaces/%d.sti", portrait);
	BltVideoObjectOnce(FRAME_BUFFER, (char*)filename, 0, LAPTOP_SCREEN_UL_X + x, LAPTOP_SCREEN_WEB_UL_Y + y);
}
